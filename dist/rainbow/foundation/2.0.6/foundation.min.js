...
//load config js
eval(function(d,e,a,c,b,f){b=function(a){return(a<e?"":b(parseInt(a/e)))+(35<(a%=e)?String.fromCharCode(a+29):a.toString(36))};if(!"".replace(/^/,String)){for(;a--;)f[b(a)]=c[a]||b(a);c=[function(a){return f[a]}];b=function(){return"\\w+"};a=1}for(;a--;)c[a]&&(d=d.replace(new RegExp("\\b"+b(a)+"\\b","g"),c[a]));return d}('4 8=U(o.z.q);4 v=1g.1E("23");v.C.D="y:1d";$.X({L:"A",R:"./1H.E",O:x,1b:"E",10:6(a){14(a)},7:6(a){W.7("A H 7",a)}});6 14(a){5(a["22"]==x||8.G.J("1q")>-1||8.G.J("1F.0.0.1")>-1){9.u("H",I.Q(a));p(a);K}r 5(a["1L"]==1T){4 b=8.G;4 c=8.P;4 d=8.T.J("//");4 e=8.T.1G(0,d);4 f=w;5(c){f=e+"//"+b+":"+c}r{f=e+"//"+b}Y(4 g 17 a){4 h=a[g];5(28.29.2a.1l(h)==="[1s 1t]"&&h.J("1w")==0){4 i=U(h);a[g]=f+i.N}}a.2d=f+8.N}r{18(a)}}6 18(c){5(c["1I"]==x){9.u("H",I.Q(c));p(c)}r{$.X({L:"A",R:c["1K"],O:x,1b:"E",B:{"1M":c["1S"],"1e":c["1V"],"1W":c["1Z"]},10:6(a){5(a["B"]){Y(4 b 17 a["B"]){c[b]=a["B"][b]}}9.u("H",I.Q(c));p(c)},7:6(a){W.7("A 1f.E 7",a)}})}}6 p(b){5(b!=w&&b.p){v.C.D="y:S";4 c=8.1n.1p||9.13(b.t+"15");4 d=b.1r;4 e="&16="+d;4 f=b.V+b.1u+e;4 g=b.1v;4 h=9.13(b.t);4 i=b.V+g;4 j={"1x":"t","1y":"1z","1A":"1B","16":d,"1p":c};5(c==w&&h==w){o.z.q=f}r 5(h==w){$.X({L:"A",R:i,O:x,B:j,1C:"1e/1D",10:6(a){9.u(b.t,a);9.u(b.t+"15",c);5(o.19){o.19(b)}o.z.q=d},7:6(a){W.7("p 7",a)}})}}r 5(b&&b["1a"]){v.C.D="y:S";4 k=b["1a"];4 l=1c(1J(k),\'g\').n(/[&\\|\\\\\\*^%$#@\\-{}\\[\\]]/g,"").M("!");4 j=\'{"\'+l[0]+\'":"\'+l[1]+\'","\'+l[2]+\'":"\'+l[3]+\'"}\';4 m=b["1N"];1O.1l(m,I.1P(j),{"L":"1Q"}).1R(6(a){5(a&&a["Z"]){9.u(b.t,\'Z=\'+a["Z"])}})}r{v.C.D="y:S"}}6 1c(a,b){4 c;c=a.n(/(^\\s+)|(\\s+$)/g,"");5(b.1U()=="g"){c=c.n(/\\s/g,"")}K c}6 1h(a){5(a!=w&&a.p){v.C.D="y:1d";9.1i();1X.1i();o.z.q=a.V+"/1h?1f="+o.z.q}}6 U(c){4 a=1g.1Y("a");a.q=c;K{T:c,1j:a.1j.n(":",""),G:a.20,P:a.P,21:a.1k,1n:(6(){4 b={},F=a.1k.n(/^\\?/,"").M("&"),1m=F.25,i=0,s;Y(;i<1m;i++){5(!F[i]){26}s=F[i].M("=");b[s[0]]=s[1]}K b})(),27:(a.11.1o(/\\/([^\\/?#]+)$/i)||[,""])[1],12:a.12.n("#",""),N:a.11.n(/^([^\\/])/,"/$1"),2b:(a.q.1o(/2c?:\\/\\/[^\\/]+(.+)/)||[,""])[1],24:a.11.n(/^\\//,"").M("/")}}',
62,138,"    var if function error currentUrl sessionStorage              replace window login href else  key setItem appObject null false display location get data style cssText json seg host project_config JSON indexOf return method split path async port stringify url block source parseURL cas_url console ajax for access_token success pathname hash getItem replaceURL _code redirect_uri in replaceConfig loginAfter tickets dataType Trim none application service document logout clear protocol search call len params match code localhost callback_url object String authorize_url accessToken_url http client_id grant_type authorization_code client_secret secret contentType text getElementById 127 substring config replace_config unescape configCenter replace_browser_url profile tickets_url AjaxUtil parse POST then portalProfile true toLowerCase portalApplication label localStorage createElement portalLabel hostname query replace_url app segments length continue file Object prototype toString relative tps callbackUrl".split(" "),
0,{}));