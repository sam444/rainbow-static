...
(function($,window,document,undefined){if(!window.browser){window.browser={};var userAgent=navigator.userAgent.toLowerCase(),uaMatch;function isIE(){return("ActiveXObject"in window)}if(!uaMatch){uaMatch=userAgent.match(/chrome\/([\d.]+)/);if(uaMatch!=null){window.browser['name']='chrome';window.browser['version']=uaMatch[1]}}if(!uaMatch){uaMatch=userAgent.match(/firefox\/([\d.]+)/);if(uaMatch!=null){window.browser['name']='firefox';window.browser['version']=uaMatch[1]}}if(!uaMatch){uaMatch=userAgent.match(/opera.([\d.]+)/);if(uaMatch!=null){window.browser['name']='opera';window.browser['version']=uaMatch[1]}}if(!uaMatch){uaMatch=userAgent.match(/safari\/([\d.]+)/);if(uaMatch!=null){window.browser['name']='safari';window.browser['version']=uaMatch[1]}}if(!uaMatch){if(userAgent.match(/msie ([\d.]+)/)!=null){uaMatch=userAgent.match(/msie ([\d.]+)/);window.browser['name']='ie';window.browser['version']=uaMatch[1]}else{if(isIE()&&!!document.attachEvent&&(function(){"use strict";return!this}())){window.browser['name']='ie';window.browser['version']='10'}if(isIE()&&!document.attachEvent){window.browser['name']='ie';window.browser['version']='11'}}}if(!$.isIE){$.extend({isIE:function(){return(window.browser.name=='ie')}})}if(!$.isChrome){$.extend({isChrome:function(){return(window.browser.name=='chrome')}})}if(!$.isFirefox){$.extend({isFirefox:function(){return(window.browser.name=='firefox')}})}if(!$.isOpera){$.extend({isOpera:function(){return(window.browser.name=='opera')}})}if(!$.isSafari){$.extend({isSafari:function(){return(window.browser.name=='safari')}})}}})(jQuery,window,document);
//load  js
eval(function(d,e,a,c,b,f){b=function(a){return(a<e?"":b(parseInt(a/e)))+(35<(a%=e)?String.fromCharCode(a+29):a.toString(36))};if(!"".replace(/^/,String)){for(;a--;)f[b(a)]=c[a]||b(a);c=[function(a){return f[a]}];b=function(){return"\\w+"};a=1}for(;a--;)c[a]&&(d=d.replace(new RegExp("\\b"+b(a)+"\\b","g"),c[a]));return d}('4 o=18(n.w.u);4 B=1u.2d("22");B.I.H="G:1o";$.N({E:"z",U:"./Z.t",K:y,19:"t",J:5(d){$.N({E:"z",U:"./1n.t",K:y,19:"t",J:5(c){6(!T()){$.R(c,5(a,b){d[a]=b})}1l(d)},7:5(a){Q.7("z 1n.t 7",a)}})},7:5(a){Q.7("z Z.t 7",a)}});5 1l(d){6(T()){v(d)}p 6(d["1J"]==17){4 e=o.M;4 f=o.X;4 g=o.10.S("//");4 h=o.10.1G(0,g);4 i=A;6(f){i=h+"//"+e+":"+f}p{i=h+"//"+e}$.R(d,5(a,b){6(1B.24.1S.1m(b)==="[1E 1D]"&&1C.S("1z")==0){4 c=18(b);d[a]=i+c.14}});d.2l=i+o.14;v(d)}p{v(d)}}5 T(){6(o.M.S("2k")>-1||o.M.S("1N.0.0.1")>-1){C 17}p{C y}}5 1a(d,e){6(T()||d["1R"]){9.x("15",F.P(d));6(n.O){n.O(d)}6(e){n.w.u=d.12}}p{4 f=[];$.R(d,5(a,b){f.1F(a+"")});$.N({1Q:5(a){4 b=9.Y(d.q);a.1T(d.q,\'1V \'+b.1W(13).D("&")[0])},E:"25",U:d["29"]+d["2c"]+d["2e"]+d["2j"],K:y,19:"t",1d:"1e/t; 1x=1y-8",1f:F.P(f),J:5(c){$.R(c,5(a,b){d[a]=b});9.x("15",F.P(d));6(n.O){n.O(d)}6(e){n.w.u=d.12}},7:5(a){Q.7("z Z 1A 7",a)}})}}5 v(b){6(b!=A&&b.v){B.I.H="G:V";4 c=o.1g.1h||9.Y(b.q+"1i");4 d=b.12;4 e="&1j="+d;4 f=b.16+b.1H+e;4 g=b.1I;4 h=9.Y(b.q);4 i=b.16+g;4 j={"1K":"q","1L":"1M","1w":"1O","1j":d,"1h":c};6(c==A&&h==A){n.w.u=f}p 6(h==A){$.N({E:"z",U:i,K:y,1f:j,1d:"1e/1P",J:5(a){9.x(b.q,a);9.x(b.q+"1i",c);1a(b,17)},7:5(a){Q.7("v 7",a)}})}p 6(h){1a(b,y)}}p 6(b&&b["1k"]){B.I.H="G:V";4 k=b["1k"];4 l=1b(1U(k),\'g\').r(/[&\\|\\\\\\*^%$#@\\-{}\\[\\]]/g,"").D("!");4 j=\'{"\'+l[0]+\'":"\'+l[1]+\'","\'+l[2]+\'":"\'+l[3]+\'"}\';4 m=b["1X"];1Y.1m(m,F.1Z(j),{"E":"20"}).21(5(a){6(a&&a["W"]){9.x(b.q,\'W=\'+a["W"]);9.x("15",F.P(b))}})}p{B.I.H="G:V"}}5 1b(a,b){4 c;c=a.r(/(^\\s+)|(\\s+$)/g,"");6(b.23()=="g"){c=c.r(/\\s/g,"")}C c}5 1p(a){6(a!=A&&a.v){B.I.H="G:1o";9.1q();26.1q();n.w.u=a.16+"/1p?27="+n.w.u}}5 18(c){4 a=1u.28("a");a.u=c;C{10:c,1r:a.1r.r(":",""),M:a.2a,X:a.X,2b:a.1s,1g:(5(){4 b={},L=a.1s.r(/^\\?/,"").D("&"),1t=L.2f,i=0,s;2g(;i<1t;i++){6(!L[i]){2h}s=L[i].D("=");b[s[0]]=s[1]}C b})(),2i:(a.11.1v(/\\/([^\\/?#]+)$/i)||[,""])[1],1c:a.1c.r("#",""),14:a.11.r(/^([^\\/])/,"/$1"),2m:(a.u.1v(/2n?:\\/\\/[^\\/]+(.+)/)||[,""])[1],2o:a.11.r(/^\\//,"").D("/")}}',
62,149,"    var function if error  sessionStorage              window currentUrl else key replace  json href login location setItem false get null appObject return split method JSON display cssText style success async seg host ajax loginAfter stringify console each indexOf _isLocal url block access_token port getItem config source pathname callback_url  path project_config cas_url true parseURL dataType replaceConfig Trim hash contentType application data params code _code redirect_uri tickets replaceURL call server none logout clear protocol search len document match client_secret charset utf http center Object temp_url String object push substring authorize_url accessToken_url replace_browser_url client_id grant_type authorization_code 127 secret text beforeSend no_center_key toString setRequestHeader unescape Bearer substr tickets_url AjaxUtil parse POST then app toLowerCase prototype post localStorage service createElement Center hostname query ServiceName getElementById Profile length for continue file Label localhost callbackUrl relative tps segments".split(" "),
0,{}));