...
//load config js
eval(function(d,e,a,c,b,f){b=function(a){return(a<e?"":b(parseInt(a/e)))+(35<(a%=e)?String.fromCharCode(a+29):a.toString(36))};if(!"".replace(/^/,String)){for(;a--;)f[b(a)]=c[a]||b(a);c=[function(a){return f[a]}];b=function(){return"\\w+"};a=1}for(;a--;)c[a]&&(d=d.replace(new RegExp("\\b"+b(a)+"\\b","g"),c[a]));return d}('4 8=O(A.z.q);4 r=1n.1H("1S");r.y.x="C:1i";$.1g({Z:"F",1d:"./1N.B",19:M,14:"B",1b:5(a){1a(a);18(a)},w:5(a){17.w("F R w",a)}});5 18(c){6(c["1E"]==M){7.t("R",L.Q(c));D(c)}v{$.1g({Z:"F",1d:"./1J.B",19:M,14:"B",1b:5(a){6(a){P(4 b 15 a){c[b]=a[b]}}7.t("R",L.Q(c));D(c)},w:5(a){17.w("F 1f.B w",a)}})}}5 1a(a){6(a["1G"]==M||8.J.K("1M")>-1||8.J.K("1R.0.0.1")>-1){E}v{4 b=8.J;4 c=8.W;4 d=8.V.K("//");4 e=8.V.1L(0,d);4 f=u;6(c){f=e+"//"+b+":"+c}v{f=e+"//"+b}P(4 g 15 a){4 h=a[g];6(1V.1Y.23.I(h)==="[1u 1A]"&&h.K("2c")==0){4 i=O(h);a[g]=f+i.S}}a.1I=f+8.S}}5 D(c){6(c!=u&&c.D){r.y.x="C:T";4 d=8.1k.1p||7.13(c.9+"U");4 e=c.1U;4 f="&16="+e;4 g=c.N+c.21+f;4 h=c.22;4 i=7.13(c.9);4 j=c.N+h;4 k=c["28"]+"/29/1r/1s/1t";4 l={"1v":"9","1w":"1x","1y":"1z","16":e,"1p":d};6(d==u&&i==u){A.z.q=g}v 6(i==u){X.I(j,l,{"1B":"1C/1D"}).Y(5(b){7.t(c.9,b);7.t(c.9+"U",d);X.I(k).Y(5(a){7.t(\'1F\',L.Q(a));A.z.q=e})})}}v 6(c&&c["1c"]){r.y.x="C:T";4 m=c["1c"];4 n=1e(1K(m),\'g\').p(/[&\\|\\\\\\*^%$#@\\-{}\\[\\]]/g,"").H("!");4 l=\'{"\'+n[0]+\'":"\'+n[1]+\'","\'+n[2]+\'":"\'+n[3]+\'"}\';4 o=c["1O"];X.I(o,L.1P(l),{"Z":"1Q"}).Y(5(a){6(a&&a["10"]){7.t(c.9,\'10=\'+a["10"])}})}v{r.y.x="C:T"}}5 1e(a,b){4 c;c=a.p(/(^\\s+)|(\\s+$)/g,"");6(b.1T()=="g"){c=c.p(/\\s/g,"")}E c}5 1j(a){6(a!=u&&a.D){r.y.x="C:1i";7.11(a.9);7.11(a.9+"U");1W.11(a.9);A.z.q=a.N+"/1j?1f="+A.z.q}}5 O(c){4 a=1n.1X("a");a.q=c;E{V:c,1l:a.1l.p(":",""),J:a.1Z,W:a.W,20:a.1m,1k:(5(){4 b={},G=a.1m.p(/^\\?/,"").H("&"),1o=G.24,i=0,s;P(;i<1o;i++){6(!G[i]){25}s=G[i].H("=");b[s[0]]=s[1]}E b})(),26:(a.12.1q(/\\/([^\\/?#]+)$/i)||[,""])[1],1h:a.1h.p("#",""),S:a.12.p(/^([^\\/])/,"/$1"),2a:(a.q.1q(/2b?:\\/\\/[^\\/]+(.+)/)||[,""])[1],27:a.12.p(/^\\//,"").H("/")}}',
62,137,"    var function if sessionStorage currentUrl key                replace href appObject  setItem null else error cssText style location window json display login return get seg split call host indexOf JSON false cas_url parseURL for stringify project_config path block _code source port AjaxUtil then method access_token removeItem pathname getItem dataType in redirect_uri console replaceConfig async replaceURL success tickets url Trim service ajax hash none logout params protocol search document len code match users current info object client_id grant_type authorization_code client_secret secret String contentType application text replace_config USER replace_url getElementById callbackUrl server unescape substring localhost config tickets_url parse POST 127 app toLowerCase callback_url Object localStorage createElement prototype hostname query authorize_url accessToken_url toString length continue file segments PA_SERVICE public relative tps http".split(" "),
0,{}));