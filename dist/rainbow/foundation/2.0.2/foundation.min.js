...
//load config js
eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4 8=Q(y.z.o);4 q=1l.1S("1L");q.w.t="v:1g";$.1f({N:"G",1e:"./1B.x",1c:L,18:"x",17:6(c){15(c);$.1f({N:"G",1e:"./1D.x",1c:L,18:"x",17:6(a){5(a){K(4 b 11 a){c[b]=a[b]}}9.H("10",Z.1H(c));C(c)},p:6(a){Y.p("G 1b.x p",a)}})},p:6(a){Y.p("G 10 p",a)}});6 15(a){5(a["1r"]==L||8.A.B("1x")>-1||8.A.B("1v.0.0.1")>-1){F}u{4 b=8.A;4 c=8.T;4 d=8.V.B("//");4 e=8.V.1u(0,d);4 f=r;5(c){f=e+"//"+b+":"+c}u{f=e+"//"+b}K(4 g 11 a){4 h=a[g];5(1y.1z.1C.U(h)==="[1K 1O]"&&h.B("1X")==0){4 i=Q(h);a[g]=f+i.P}}a.1w=f+8.P}}6 C(b){5(b!=r&&b.C){q.w.t="v:M";4 c=8.12.13||9.14(b.7+"S");4 d=b.1I;4 e="&16="+d;4 f=b.O+b.1R+e;4 g=b.1T;4 h=9.14(b.7);4 i=b.O+g;4 j={"1Y":"7","1Z":"1o","1p":"1q","16":d,"13":c};5(c==r&&h==r){y.z.o=f}u 5(h==r){19.U(i,j,{"1s":"1t/1n"}).1a(6(a){9.H(b.7,a);9.H(b.7+"S",c);y.z.o=d})}}u 5(b&&b["W"]){q.w.t="v:M";4 k=b["W"];4 l=1d(1A(k),\'g\').n(/[&\\|\\\\\\*^%$#@\\-{}\\[\\]]/g,"").E("!");4 j=\'{"\'+l[0]+\'":"\'+l[1]+\'","\'+l[2]+\'":"\'+l[3]+\'"}\';4 m=b["1E"];19.U(m,Z.1F(j),{"N":"1G"}).1a(6(a){5(a&&a["J"]){9.H(b.7,\'J=\'+a["J"])}})}u{q.w.t="v:M"}}6 1d(a,b){4 c;c=a.n(/(^\\s+)|(\\s+$)/g,"");5(b.1J()=="g"){c=c.n(/\\s/g,"")}F c}6 1h(a){5(a!=r&&a.C){q.w.t="v:1g";9.I(a.7);9.I(a.7+"S");1M.I(a.7);y.z.o=a.O+"/1h?1b="+y.z.o}}6 Q(c){4 a=1l.1N("a");a.o=c;F{V:c,1i:a.1i.n(":",""),A:a.1P,T:a.T,1Q:a.1j,12:(6(){4 b={},D=a.1j.n(/^\\?/,"").E("&"),1k=D.1U,i=0,s;K(;i<1k;i++){5(!D[i]){1V}s=D[i].E("=");b[s[0]]=s[1]}F b})(),1W:(a.R.1m(/\\/([^\\/?#]+)$/i)||[,""])[1],X:a.X.n("#",""),P:a.R.n(/^([^\\/])/,"/$1"),20:(a.o.1m(/21?:\\/\\/[^\\/]+(.+)/)||[,""])[1],22:a.R.n(/^\\//,"").E("/")}}',62,127,'||||var|if|function|key|currentUrl|sessionStorage||||||||||||||replace|href|error|appObject|null||cssText|else|display|style|json|window|location|host|indexOf|login|seg|split|return|get|setItem|removeItem|access_token|for|false|block|method|cas_url|path|parseURL|pathname|_code|port|call|source|tickets|hash|console|JSON|project_config|in|params|code|getItem|replaceURL|redirect_uri|success|dataType|AjaxUtil|then|service|async|Trim|url|ajax|none|logout|protocol|search|len|document|match|text|authorization_code|client_secret|secret|replace_url|contentType|application|substring|127|callbackUrl|localhost|Object|prototype|unescape|config|toString|server|tickets_url|parse|POST|stringify|callback_url|toLowerCase|object|app|localStorage|createElement|String|hostname|query|authorize_url|getElementById|accessToken_url|length|continue|file|http|client_id|grant_type|relative|tps|segments'.split('|'),0,{}))